...
<div class="content" transition="bounce" style="margin-bottom:1.8rem;">
  <header class="bar bar-nav">
    ...
    <a class="icon pull-right" style="color:white;font-size:0.7rem;" @click="reward()">
      打赏
    </a>
    <h1 class="title color" style="color:white">方案详情</h1>
  </header>
  <div class="list-block">
    <ul>
      <li class="item-content">
        <div style="width:100%;">
          <div style="margin-left:-0.4rem; display:block;">
              <span style="display:block; float:left;">信心指数</span>
              <span v-if="plan.planConfident===-1 || plan.planConfident>0" style="width:.3rem; height:.3rem; border-radius:2rem; background-color:#3cdbbb; float:left; margin-left:0.4rem;display:block;margin-top:0.3rem;"></span>
              <span v-if="plan.planConfident===-1 || plan.planConfident>1" style="width:.3rem; height:.3rem; border-radius:2rem; background-color:#3cdbbb;float:left; margin-left:0.2rem;display:block;margin-top:0.3rem;"></span>
              <span v-if="plan.planConfident===-1 || plan.planConfident>2" style="width:.3rem; height:.3rem; border-radius:2rem; background-color:#3cdbbb;float:left; margin-left:0.2rem;display:block;margin-top:0.3rem;"></span>
              <span v-if="plan.planConfident>3"  style="width:.3rem; height:.3rem; border-radius:2rem; background-color:#3cdbbb;float:left; margin-left:0.2rem;display:block;margin-top:0.3rem;"></span>
              <span v-if="plan.planConfident>3"  style="width:.3rem; height:.3rem; border-radius:2rem; background-color:#3cdbbb;float:left; margin-left:0.2rem;display:block;margin-top:0.3rem;"></span>
          </div>
      ...
      <li class="item-content" v-if="!plan.plan_content"
        style="margin-top:-0.6rem;background-color:#2e96ef;">
        <div style="width:180%;">
  ...
  export default {
    ...
    data () {
      return {
        ...
        userId: window.localStorage.getItem('usUser') ? JSON.parse(window.localStorage.getItem('usUser')).user_id : null,
        loading: false,
        pagenum: 0
      }
    },
