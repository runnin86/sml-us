...
<div class="content findPwd" transition="bounce" style="background:#fff;">
  <header class="bar bar-nav">
    ...
    <button @click="complete()"
      style="margin-right:0.1rem;font-size:0.78rem;color:white;"
      class="button button-link button-nav pull-right">
      完成
    </button>
    <h1 class="title color" style="color:white;">找回密码</h1>
  </header>
  <div class="list-block" style="margin-top:2.2rem;font-size:0.72rem;">
    <ul>
      <li class="item-content"
        ...
        <div class="item-inner-fwd" style="color:#333333">
    ...
    <ul>
      <li>
        <div class="item-content">
          ...
          <div class="item-inner-fwd" style="margin-top:.6rem;height:3rem;">
      ...
      <li>
        <div class="item-content" style="height:4rem;">
...
export default {
  ...
  data () {
    return {
      userPhone: window.localStorage.getItem('localUsPhone'),
      vCode: '',
      password: ''
    }
  },
