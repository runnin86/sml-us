<template>
  <div class="container">
    <nav class="bar bar-nav">
      <h1 class="title color" style="color:white">购物车</h1>
    </nav>
            ...
            <div class="item-inner" style="padding:0.2rem;">
              ...
              <div class="item-title-sml" style="margin-left:-1.6rem;">
                <div style="margin-top:0.2rem;">
                  ...
                  <span class="pull-right" style="margin-right:2rem;">
                    {{plan.addTime}}
                  </span>
                </div>
              ...
              <div  @click="delCartPlan(plan.pid)" style="z-index:9999">
                <img src="/img/购物车/删除.png" width="32" height="32" >
              </div>
            </div>
          </li>
        </ul>
      </div>
      <div v-cloak v-if="showPlanWarning" style="width:100%;height:100%;text-align:center;margin-top:10rem;">
        <div>
        ...
        <li class="item-content bottomLi">
          <div class="item-inner" style="padding-left:0.75rem;">
            ...
            <div class="toPay-button">
              <button class="button button-fill button-danger" style="background-color:#2e96ef;color:white" @click="payPlan()">付款</button>
            </div>
          </div>
        </li>
      </ul>
